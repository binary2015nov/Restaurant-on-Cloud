...
his_orders = st.Page("his_orders.py", title="History orders", icon="📝")
...
if st.session_state.logged_in:
    pg = st.navigation([order_pg, his_orders, his_trend,ingre_profits,ingre_sales,ivt_monitor, logout_page])
else:
